...
#[cfg(windows)]
use windows::Win32::System::ProcessStatus::*; // For GetProcessMemoryInfo if needed, or stick to sysinfo for basic mem

// Shared state for CPU usage calculation
static LAST_CPU_TIMES: Lazy<RwLock<HashMap<u32, u64>>> = 
