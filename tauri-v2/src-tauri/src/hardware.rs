...
fn detect_intel_hybrid(model: &str) -> Option<(u32, u32)> {
    ...
    // 12代 Alder Lake
    if model_upper.contains("12900") { return Some((8, 8)); }
    if model_upper.contains("12700") { return Some((8, 4)); }
    if model_upper.contains("12600K") { return Some((6, 4)); }
    if model_upper.contains("12400") { return Some((6, 0)); }
    
    // 13代 Raptor Lake
    if model_upper.contains("13900") { return Some((8, 16)); }
    if model_upper.contains("13700") { return Some((8, 8)); }
    if model_upper.contains("13600") { return Some((6, 8)); }
    if model_upper.contains("13400") { return Some((6, 4)); }
    
    // 14代 Raptor Lake Refresh
    if model_upper.contains("14900") { return Some((8, 16)); }
    if model_upper.contains("14700") { return Some((8, 12)); }
    if model_upper.contains("14600") { return Some((6, 8)); }
