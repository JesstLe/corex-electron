...
export default function Toast({ message, type = 'success', duration = 3000, onClose }) {
    ...
    return (
        <div
            className={`fixed top-6 right-6 z-50 flex items-center gap-3 px-4 py-3 rounded-xl border shadow-lg transition-all duration-300 ${variant.bg} ${variant.border} ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-4'
                }`}
